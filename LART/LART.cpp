...
void cornell_box1() {
    ...
    shared_ptr<hittable> bunny = parseOBJ("./obj/bunny_reduced_8x.obj", pink);
    bunny = make_shared<rotate_y>(bunny, 180);
    bunny = make_shared<translate>(bunny, vec3(160, -60, 250));
    world.add(bunny);

    shared_ptr<hittable> box1 = box(point3(0, 0, 0), point3(165, 330, 165), blue_metal);
    box1 = make_shared<rotate_y>(box1, 15);
    box1 = make_shared<translate>(box1, vec3(265, 0, 320));
    world.add(box1);
    ...
    cam.vfov = 40;
    cam.lookfrom = point3(278, 278, -770);
    cam.lookat = point3(278, 278, 0);
    cam.vup = vec3(0, 1, 0);
