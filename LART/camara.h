    ...
    public:
        ...
        void render(const hittable& world) {
		    ...
		    for (int j = 0; j < image_height; j++) {
                ...
                std::string progress = "\rProcessing: |";
                for (int i = 0; i < 20; i++) {
                    if (i < 20 * j / image_height) {
                        progress += "*";
                    }
                    else {
                        progress += "-";
                ...
                progress += "| ";
                std::clog << progress << 100 * j / image_height << "% " << duration.count() / 1000000 * (image_height - j - 1) / (j + 1) << " seconds remaining";
		    ...
		    if (stbi_write_png(filename.c_str(), image_width, image_height, 3, image.data(), image_width * 3)) {
			    std::cout << "\rWrote image.png                       \n";
		    }
		    else {
			    std::cout << "\rFailed to write image.png             \n";
		    }
        }
